...
function mostrarCarrito() {
  ...
  carrito.forEach(function (producto) {
    listaHTML += `<li>
    <button onclick="btnDecrementar(${producto.cantidad}, ${producto.id})">-</button>
    ${producto.cantidad} 
    <button onclick="btnIncrementar(${producto.cantidad}, ${producto.id})">+</button>
...
// Función para Aumentar la cantidad en la lista del carrito
function btnIncrementar(cantidadActual, id) {
  let carrito = JSON.parse(localStorage.getItem("carrito")) || [];
  ...
  if (productoEnCarrito) {
    ...
    mostrarCarrito(); // Ajusta el nombre según tu función de mostrar carrito
  }
}

// Función para disminuir la cantidad en la lista del carrito
function btnDecrementar(cantidadActual, id) {
  let carrito = JSON.parse(localStorage.getItem("carrito")) || [];
  let productoEnCarrito = carrito.find((producto) => producto.id === id);
